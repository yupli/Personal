...
本站「运筹优化」栏目（`docs/or-opt/`）中许多条目的**概念界定、记号称谓、式号/图号与教材影印**在整理时参考了《**运筹优化常用模型、算法及案例实战**》一书；正文中已出现的「教材」「原书式」、章节式号等说明，在不必逐条标注出处的默认约定下，多可与该书互查。若你自行引用本站笔记，请同时尊重原书版权与引注规范，并以正式出版物为准作学术引用。
