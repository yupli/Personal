...
| 问题 | 说明 | 链接 |
|------|------|------|
| 指派问题 | N 对 N 一一指派；二部图匹配、0–1 模型；匈牙利算法与图解示例 | [查看](classic-models/assignment-problem.md) |
...
| 车辆路径问题 | 背景；CVRP (1)–(9) 含 MTZ 累计载重 $u_{ik}$ (6)–(8)；VRPTW 叠加 (10)–(12)（$s_{ik}$、$M_{ij}^{t}$） | [查看](classic-models/vehicle-routing-problem.md) |
