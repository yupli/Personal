...
**注**：为直观展示，可参见文献 Cappanera and Scaparra, 2011 中的示例网络；示例网络见下图 2.13。文中另有两类商品数值例：商品 1 为 $[1,7,25]$（自节点 1 至 7、需求 25），商品 2 为 $[2,6,2]$；另有文献给出总成本 1873 的数值解，对应可查阅该文献中的图 2.14 类图例，此处不另贴。弧上成对方括号在常见记法中常表示费用与容量等参数对，本图主要保留拓扑作示意。
