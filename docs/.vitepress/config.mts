    ...
    sidebar: {
      "/or-opt/": [
        ...
        },
        {
          ...
          collapsed: false,
          items: [
            { text: "分支定界（B&B）", link: "/or-opt/branch-and-bound" },
            { text: "分支切割（B&C）", link: "/or-opt/branch-and-cut" },
            { text: "列生成（Column Generation）", link: "/or-opt/column-generation" },
            { text: "分支定价（B&P）", link: "/or-opt/branch-and-price" },
            { text: "分支定价切割（BPC）", link: "/or-opt/branch-price-and-cut" },
          ...
          items: [
            { text: "基础启发式（Simple Heuristics）", link: "/or-opt/simple-heuristics" },
            {
              ...
              items: [
                ...
                { text: "贪婪随机自适应搜索过程（GRASP）", link: "/or-opt/grasp" },
